...
SECRET_KEY = 'django-insecure-ba=z*n-4vp@@&_mswk%0)y@@p4d(ph+y373d8i89w=g355^u^n'
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    {
        'NAME': 'main.validators.PreventReusePasswordValidator',  # Ścieżka do nowego walidatora
    },
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [],
        'APP_DIRS': True,  # Umożliwia Django znajdowanie szablonów w katalogach aplikacji
        'OPTIONS': {
            'context_processors': [
...
SESSION_ENGINE = 'django.contrib.sessions.backends.db'  # Możesz używać bazy danych do przechowywania sesji
SESSION_COOKIE_NAME = 'sessionid'  # Nazwa pliku cookie, który przechowuje identyfikator sesji
