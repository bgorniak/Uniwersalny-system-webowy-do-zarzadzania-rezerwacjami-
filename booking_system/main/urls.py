...
from .admin import DataSummaryAdminView
...
urlpatterns = [
    ...
    path('admin/reservations/', views.confirm_reservation_cancellation, name='admin_reservations'),

    path('confirm_reservation_cancellation/<int:reservation_id>/', views.confirm_reservation_cancellation, name='confirm_reservation_cancellation'),
    ...
    path('admin/data-summary/', DataSummaryAdminView().data_summary_view, name='data-summary'),
    path('admin/data-summary/export-csv/', DataSummaryAdminView().export_csv, name='export-csv'),
    path('admin/data-summary/export-pdf/', DataSummaryAdminView().export_pdf, name='export-pdf'),
